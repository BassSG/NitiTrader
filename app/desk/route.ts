...
export async function GET(){
 const brandedHtml=documentHtml
  ...
  .replace('<link rel="manifest" href="/manifest.webmanifest">','<link rel="manifest" href="/manifest.webmanifest"><link rel="apple-touch-icon" href="/niti-trader-icon-192.png"><script src="/niti-enhancements.js?v=1.6.1"></script>')
